...
public class DBManager extends SQLiteOpenHelper {
    ...
    public void addStudent(Student student) {
        ...
        values.put(IDNUM, student.getMidnum());
    ...
    public List<Student> getAllStudent() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                student.setMidnum(cursor.getString(4));
    ...
    public int updateStudent(Student student){
        ...
        contentValues.put(IDNUM,student.getMidnum());
    ...
    public int checkUser(Student student)
    {
        int id=-1;
        SQLiteDatabase db=this.getReadableDatabase();
        Cursor cursor=db.rawQuery("SELECT id FROM students WHERE name=? AND idnumber=?",new String[]{student.getmName(),student.getMidnum()});
